...
class RawGpsPointsLayer(private val routeRecorder: RouteRecorder) : Layer() {
    ...
    override fun draw(boundingBox: BoundingBox, zoomLevel: Byte, canvas: Canvas, topLeftPoint: Point, rotation: Rotation) {
        /*
        Draws every raw recorded GPS point as a dot, independent of the snapped-to-road chains drawn
        by PathOverlayLayer, so you can see how far raw fixes drift from the paths they got matched to.
        */
